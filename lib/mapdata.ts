...
export const TRADE_LANES: TradeLane[] = [
  {
    ...
    coordinates: [
      ...
      [20.0, -38.0], [18.5, -34.4],
      [16.0, -33.0], [12.0, -30.0], [8.0, -25.0],
      [4.0, -18.0],  [0.0, -10.0],  [-3.0, -2.0],
      [-5.0, 5.0],   [-8.0, 12.0],  [-12.0, 20.0],
      [-14.0, 28.0], [-13.0, 35.0], [-9.0, 39.0],
      [-5.0, 43.0],  [-2.0, 47.0],  [4.1, 51.9],
    ],
  },
  {
  ...
  },
  {
    ...
    coordinates: [
      ...
      [34.0, -26.0], [26.0, -34.0], [18.5, -34.4],
      [12.0, -30.0], [6.0, -22.0],  [2.0, -12.0],
      [-2.0, -2.0],  [-5.0, 8.0],   [-8.0, 18.0],
      [-12.0, 28.0], [-10.0, 36.0], [-5.0, 43.0],
      [4.1, 51.9],
    ],
  },
  {
  ...
  },
  {
    ...
    riskLevel: 'low',
    coordinates: [
      [-43.2, -22.9], [-41.0, -18.0], [-38.5, -12.0],
      [-36.0, -6.0],  [-34.0, 0.0],   [-31.0, 5.0],
      [-28.0, 10.0],  [-25.0, 15.0],  [-22.0, 20.0],
      [-18.5, 25.0],  [-15.0, 30.0],  [-11.0, 35.0],
      [-7.0, 39.0],   [-3.0, 43.0],   [-1.0, 47.0],
      [4.1, 51.9],
    ],
  },
]
